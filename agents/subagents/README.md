...
| [`java-refactor-evidence-curator`](java-refactor-evidence-curator.md) | `cognitive-doc-design` | Curates compact Java refactor evidence summaries into final evidence without reading raw source or reports |
...
| [`scout`](scout.md) | [`refactorch-phases`](../../skills/refactorch-phases/) | Builds or refreshes the reusable RefactorCh Project Profile for a repository |
