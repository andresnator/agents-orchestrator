...
description: Fully automatic SDD orchestrator. Delegates each phase to specialized subagents (scanner, spec-writer, coder, test-writer, verifier) via Task tool. Runs in isolated worktree, reports progress, and merges to origin on completion.
