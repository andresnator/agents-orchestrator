...
- `domains/sdd/agents/sdd-swarm-worker.md` — the isolated-worktree variant of the implementation receipt; the deterministic controller requires exact task, assertion, changed-file, validation, and commit agreement before cherry-pick.
