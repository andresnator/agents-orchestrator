...
|---|---|---|
| Orchestration | `sdlc-orchestrator`, `deep-planner`, `refactor-planner`, `architect`, `orchestraitor`, `orchestralite`, `review-coordinator` | Strongest reasoning; suggested `high` variant |
