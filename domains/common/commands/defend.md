...
3. Interrogate one decision at a time in chat following the `grilling` skill: state the decision as you observed it, ask why, and attach as the recommended answer the strongest justification you can construct for it. Stop and wait after each question.
