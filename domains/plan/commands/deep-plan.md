...
Delegate this workflow to the primary agent `plan-architect` using the exact raw arguments above.
...
- Allowed runtime write path: `.ai/plan-architect/plans/**` only — one plan document per goal.
