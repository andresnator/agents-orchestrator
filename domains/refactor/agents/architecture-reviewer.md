...
Decide whether the problem is local or architectural; classify broad cleanup as follow-up unless required for safe characterization.

## Required skills

Load before analysis:

- the architecture-impact-review skill
