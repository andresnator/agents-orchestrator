...
3. **Kickoff (one round)**: prepare mode-specific questions via `native-question-ux`, skipping anything the user already stated, and send them through the Question boundary. Do NOT ask about Mode/TDD/Judgment; those belong to SDD intake.
