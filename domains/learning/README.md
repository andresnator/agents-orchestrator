...
| Skill | `lesson-audio` | Synthesize listen-first audio for dialogue units |
...
graph TD
    ...
    M -- language topic --> LW["language-loop two waves:<br/>passive: new bilingual dialogue unit<br/>+ listen-first audio (lesson-audio)<br/>active: BDT retranslation of unit N-5"]
