...
- **Steps:**
  ...
  3. Replay that request ID, send an unrelated request ID, and stage a new choice before answering the old one. Settle 200 choices across sessions, then stage another.
...
- **Steps:**
  ...
  4. Inspect `.ai/learning/<topic>/.state.json`, `mission.md`, `path.md`, `review-queue.md`, `vocabulary.md`, and `gaps.md`.
