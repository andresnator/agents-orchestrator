...
No state discovery, calendar check, file write or automatic saving. This method needs no named agent, sibling skill or project directory. A caller may separately save an explicitly requested draft without creating a route or scheduled obligation.
