...
Return one bounded JSON object: `{"kind":"summary","title":"...","language":"...","markdown":"..."}`. Compose the complete Markdown yourself. Never include route state, unrelated dialogue, progress or save claims. No filesystem access, external research, questions or delegation. The caller owns exclusive deterministic creation after validating the matching save interaction and result.
