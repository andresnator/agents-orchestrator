...
- One file per capability: `specs/{capability}/spec.md`. In `.orchestraitor/changes/`, new and modified capabilities both use delta sections; new behavior goes under ADDED Requirements.
...
6. If standalone and approved, ask before writing `.orchestraitor/changes/{change-name}/specs/{capability}/spec.md`.
