...
- New capabilities inside `.orchestraitor/changes/` still use delta headings: put all new behavior under `## ADDED Requirements`. Full `## Requirements` specs belong to canonical/base specs, not change deltas.
