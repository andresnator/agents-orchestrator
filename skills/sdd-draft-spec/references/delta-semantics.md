...
- New capabilities inside `openspec/changes/` still use delta headings: put all new behavior under `## ADDED Requirements`. Full `## Requirements` specs belong to archived/base specs, not change deltas.
