...
Use when drafting an OpenSpec `proposal.md` through interview-first SDD planning, either standalone or delegated by `grill-me-sdd`.
...
- When delegated by grill-me-sdd, return the approved draft and do not write files; the orchestrator owns the single write step.
