...
- **Thin wrappers** preserve platform boundaries; named skills like [`refactorch-phases`](skills/refactorch-phases/) own shared workflow contracts reused across agents.
